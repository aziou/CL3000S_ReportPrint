...
namespace CLDC_DataCore.SystemModel.Item
{
    ...
    public class csGlys
    {
        ...
        public void Load()
        {
            ...
            _GlysTable.Clear();
            XmlNode _XmlNode = clsXmlControl.LoadXml(Application.StartupPath + Const.Variable.CONST_GLYSDICTIONARY , out _ErrorString);
            if (_ErrorString != "")
            {
                #region 初始化功率因素字典表
                ...
                clsXmlControl.SaveXml(_XmlNode, Application.StartupPath + Const.Variable.CONST_GLYSDICTIONARY);
                #endregion
            }
