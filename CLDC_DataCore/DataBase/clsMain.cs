...
namespace CLDC_DataCore.DataBase
{
    public static class clsMain2
    {
        ...
        {
            return getIniString(sSection, skey, sDefault, System.Windows.Forms.Application.StartupPath + "\\ManageInfo.ini");
        }
        /// <summary>
        /// 获取INIp配置文件数据
        /// </summary>
        ...
        {
            WriteIni(sSection, sKey, sValue, System.Windows.Forms.Application.StartupPath + "\\ManageInfo.ini");
        }
        /// <summary>
        /// 写配置文件数据
        /// </summary>
        ...
        /// 数据营销接口对象
        /// </summary>
        internal static Interfaces.IDatatomis dataToMis = null;
        /// <summary>
        /// 是否成功家在营销接口
        /// </summary>
            ...
            foreach (string Item in System.IO.Directory.GetFiles(CLDC_DataCore.Function.File.GetPhyPath("Plugins")))
            {
                if( CLDC_DataCore.Function.File.GetExtName(Item).ToLower() == ".dll")
                {
                    ...
                    foreach (Type TypeItem in types)
                    {
                        ...
                        {
                            dataToMis = (Interfaces.IDatatomis)Activator.CreateInstance(TypeItem);       //创建实例
                            return true;
                        }
                    }
