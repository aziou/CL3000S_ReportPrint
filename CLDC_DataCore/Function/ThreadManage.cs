...
// ***************************************************************
//  ThreadManage   date: 11/25/2009 By Niaoked
//  -------------------------------------------------------------
//  Description:
//  本类应用于VerifyAdapter的线程休眠.其它非VerifyAdater中的线程或
//  是延伸线程不能用
//  -------------------------------------------------------------
//  Copyright (C) 2009 -CdClou All Rights Reserved
// ***************************************************************
// Modify Log:
// 11/25/2009 11-42-56    Created
// ***************************************************************
#endregion
using System;
...
namespace CLDC_DataCore.Function.Back
{
#if OLD
    /// <summary>
    /// 
    ...
    public class ThreadManage
    {
        ...
        private static bool Stop
        {
            get
            {
                return Comm.GlobalUnit.ForceVerifyStop ||
                    isStop || Comm.GlobalUnit.ApplicationIsOver;
            }
        }
    }
#endif
