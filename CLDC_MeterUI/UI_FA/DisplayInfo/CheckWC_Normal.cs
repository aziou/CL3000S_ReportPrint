...
namespace UI.DisplayInfo
{
    ...
    /// 基本误差检定数据
    /// </summary>
    public partial class CheckWC_Normal : Base 
    {
        /// <summary>
        ...
        public CheckWC_Normal()
        {
            InitializeComponent();
        }
        public CheckWC_Normal(Comm.Model.DnbModel.DnbInfo.MeterBasicInfo meterInfo, bool allowedit)
