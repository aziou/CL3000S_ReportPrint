...
namespace CLDC_MeterUI.UI_FA.FAPrj.PrjUI.PrjCostControl
{
    ...
    /// 费控检测- 控制功能
    /// </summary>
    public partial class CostControlInitPurse : CostControlBase
    {
        public CostControlInitPurse()
            : base()
        {
            InitializeComponent();            
        }
        public CostControlInitPurse(CLDC_DataCore.Struct.StCostControlConfig Item)
            : base(Item)
        {
            InitializeComponent();
