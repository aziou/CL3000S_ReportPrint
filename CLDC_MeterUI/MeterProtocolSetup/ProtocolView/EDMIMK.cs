...
namespace CLDC_MeterUI.ProtocolView
{
    ...
    /// </summary>
    public partial class EDMIMK : BaseControl
    {
        ...
        public bool CheckNull()
        {
            ...
            if (Txt_UserID.Text == "") Txt_UserID.Text = "EDMI";
            if (Txt_WritePwd.Text == "") Txt_WritePwd.Text = "IMDEIMDE";
            if (Txt_ClearXLPwd.Text == "") Txt_ClearXLPwd.Text = "IMDEIMDE";
        ...
        public override bool getInfo(ref CLDC_DataCore.Model.DgnProtocol.DgnProtocolInfo ProtocolInfo)
        {
            ...
            ProtocolInfo.UserID = Txt_UserID.Text;                                      //用户名
