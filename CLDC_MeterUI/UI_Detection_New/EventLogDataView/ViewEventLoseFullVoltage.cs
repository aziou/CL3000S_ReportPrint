...
{
    public partial class ViewEventLoseFullVoltage : UserControl
    {
        /// <summary>
        /// 读取全失压事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventLoseFullVoltage()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.全失压记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "全失压总次数", "事件记录发生时刻", "事件记录结束时刻" };
