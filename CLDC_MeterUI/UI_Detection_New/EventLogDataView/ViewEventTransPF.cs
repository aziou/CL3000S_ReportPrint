...
{
    public partial class ViewEventTransPF : UserControl
    {
        /// <summary>
        /// 读取功率因数超下限事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventTransPF()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.功率因数超下限记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "事件状态", "功率因数超下限总次数", "事件记录发生时刻", "事件记录结束时刻" };
