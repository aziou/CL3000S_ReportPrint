...
{
    public partial class ViewEventReversePhaseI : UserControl
    {
        /// <summary>
        /// 读取电流逆相序事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventReversePhaseI()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.电流逆相序记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "事件状态", "电流逆相序总次数", "事件记录发生时刻", "事件记录结束时刻" };
