...
{
    public partial class ViewEventACdump : UserControl
    {
        /// <summary>
        /// 读取掉电事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventACdump()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.掉电记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "事件状态", "掉电总次数", "事件记录发生时刻", "事件记录结束时刻" };
