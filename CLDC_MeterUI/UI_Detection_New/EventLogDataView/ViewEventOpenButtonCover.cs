...
{
    public partial class ViewEventOpenButtonCover : UserControl
    {
        /// <summary>
        /// 读取开端钮盖事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventOpenButtonCover()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.开端钮盒记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "事件总次数", "事件记录发生时刻", "事件记录结束时刻" };
