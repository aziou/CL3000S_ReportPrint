...
{
    public partial class ViewEventStopPhase : UserControl
    {
        /// <summary>
        /// 读取断相事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventStopPhase()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.断相记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "事件状态", "断相总次数", "事件记录发生时刻", "事件记录结束时刻" };
            ...
            Data_View.AddSpanHeader(2, 4, "【断相】事件产生（前）信息");
            Data_View.AddSpanHeader(6, 4, "【断相】事件产生（后）信息"); 
        }
        /// <summary>
        /// 刷新表单数据
        /// </summary>
