...
{
    public partial class ViewEventImbalanceI : UserControl
    {
        /// <summary>
        /// 读取电流不平衡事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventImbalanceI()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.电流不平衡记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "事件状态", "电流不平衡总次数", "事件记录发生时刻", "事件记录结束时刻" };
