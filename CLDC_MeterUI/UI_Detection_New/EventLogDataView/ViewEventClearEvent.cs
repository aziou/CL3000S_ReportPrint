...
{
    public partial class ViewEventClearEvent : UserControl
    {
        /// <summary>
        /// 读取事件清零事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventClearEvent()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.事件清零记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] {"事件清零总次数", "事件记录发生时刻", "事件清零数据标识" };
