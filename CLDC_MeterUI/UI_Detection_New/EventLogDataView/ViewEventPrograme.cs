...
{
    public partial class ViewEventPrograme : UserControl
    {
        /// <summary>
        /// 读取编程事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventPrograme()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.编程记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] {"编程总次数", "事件记录发生时刻", "事件记录操作标识" };
