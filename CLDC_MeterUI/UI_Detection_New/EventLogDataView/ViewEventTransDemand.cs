...
{
    public partial class ViewEventTransDemand : UserControl
    {
        /// <summary>
        /// 读取需量超限事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventTransDemand()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.需量超限记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "事件状态", "需量超限总次数", "事件记录发生时刻", "事件记录结束时刻" };
