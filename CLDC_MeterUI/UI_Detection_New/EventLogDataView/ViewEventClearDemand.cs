...
{
    public partial class ViewEventClearDemand : UserControl
    {
        /// <summary>
        /// 读取需量清零事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventClearDemand()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.需量清零记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] {"需量清零总次数", "事件记录发生时刻", "需量清零前正向有功需量" };
