...
{
    public partial class ViewEventReversePhaseU : UserControl
    {
        /// <summary>
        /// 读取电压逆相序事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventReversePhaseU()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.电压逆相序记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "事件状态", "电压逆相序总次数", "事件记录发生时刻", "事件记录结束时刻" };
