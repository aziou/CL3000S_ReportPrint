...
{
    public partial class ViewEventOverLoad : UserControl
    {
        /// <summary>
        /// 过载事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventOverLoad()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.过载记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "事件状态", "过载总次数", "事件记录发生时刻", "事件记录结束时刻" };
            ...
            Data_View.AddSpanHeader(2, 4, "【过载】事件产生（前）信息");
            Data_View.AddSpanHeader(6, 4, "【过载】事件产生（后）信息"); 
        }
        /// <summary>
        /// 刷新表单数据
        /// </summary>
