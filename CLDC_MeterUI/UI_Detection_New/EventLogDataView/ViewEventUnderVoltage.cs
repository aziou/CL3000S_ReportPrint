...
{
    public partial class ViewEventUnderVoltage : UserControl
    {
        /// <summary>
        /// 欠压事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventUnderVoltage()
        {
            InitializeComponent();


            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.欠压记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "事件状态", "欠压总次数", "事件记录发生时刻", "事件记录结束时刻" };
            ...
            Data_View.AddSpanHeader(2, 4, "【欠压】事件产生（前）信息");
            Data_View.AddSpanHeader(6, 4, "【欠压】事件产生（后）信息");      
        }
        /// <summary>
        /// 刷新表单数据
        /// </summary>
        ...
        private void radioBtn_A_CheckedChanged(object sender, EventArgs e)
        {
            SetData(GlobalUnit.g_CUS.DnbData.MeterGroup);
        }

        private void radioBtn_B_CheckedChanged(object sender, EventArgs e)
        {
            SetData(GlobalUnit.g_CUS.DnbData.MeterGroup);
        }

        private void radioBtn_C_CheckedChanged(object sender, EventArgs e)
        {
            SetData(GlobalUnit.g_CUS.DnbData.MeterGroup);
        }
