...
{
    public partial class ViewEventReverseTrend : UserControl
    {
        /// <summary>
        /// 读取潮流反向事件记录数据项目ID
        /// </summary>
        ...
        public ViewEventReverseTrend()
        {
            Key = ((int)CLDC_Comm.Enum.Cus_EventLogItem.潮流反向记录).ToString().PadLeft(3, '0');
        ...
        private void RefreshGrid()
        {
            ...
            string[] str_Values = new string[] { "潮流反向总次数", "事件记录发生时刻", "总有功功率方向" };
