...
{
    public partial class ViewESAMDataReturn : UserControl
    {
        /// <summary>
        /// 读取ESAM数据项目ID
        /// </summary>
        ...
        public ViewESAMDataReturn(CLDC_DataCore.Struct.StPlan_CostControl CostControlPlan)
        {
            InitializeComponent();
