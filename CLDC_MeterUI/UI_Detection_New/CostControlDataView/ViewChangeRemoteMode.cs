...
{
    public partial class ViewChangeRemoteMode : UserControl
    {

        private string Key = "023";

        public ViewChangeRemoteMode()
        {
            InitializeComponent();
        }

        public ViewChangeRemoteMode(IContainer container)
        {
            container.Add(this);
        ...
        public ViewChangeRemoteMode(CLDC_DataCore.Struct.StPlan_CostControl CostControlPlan)
        {
            InitializeComponent();
