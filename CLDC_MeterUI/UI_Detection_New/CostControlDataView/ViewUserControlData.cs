...
{
    public partial class ViewUserControlData : UserControl
    {
        /// <summary>
        /// 读取远程控制数据项目ID
        /// </summary>
        ...
        public ViewUserControlData(CLDC_DataCore.Struct.StPlan_CostControl CostControlPlan)
        {
            InitializeComponent();
