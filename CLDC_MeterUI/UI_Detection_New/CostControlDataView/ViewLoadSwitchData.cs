...
{
    public partial class ViewLoadSwitchData : UserControl
    {
        /// <summary>
        /// 读取负荷开关数据项目ID
        /// </summary>
        private const string Key = "011";
              
        public ViewLoadSwitchData()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        public ViewLoadSwitchData(CLDC_DataCore.Struct.StPlan_CostControl CostControlPlan)
        {
            InitializeComponent();
            ...
            _ColIndex = Data_View.Columns.Add("Data_Z", "  合闸  ");
            Data_View.Columns[_ColIndex].Tag = 0;
            Data_View.Columns[_ColIndex].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
            Data_View.Columns[_ColIndex].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            Data_View.Columns[_ColIndex].SortMode = DataGridViewColumnSortMode.NotSortable;
