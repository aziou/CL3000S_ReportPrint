...
{
    public partial class ViewComputation : UserControl
    {
        /// <summary>
        /// 读取计量功能项目ID
        /// </summary>
        ...
        public ViewComputation()
        {
            InitializeComponent();

            Key = ((int)CLDC_Comm.Enum.Cus_FunctionItem.计量功能).ToString().PadLeft(3, '0');            
        ...
        private void RefreshGrid()
        {
            ...
            Data_View.AddSpanHeader(6, 5, "电量信息");            
        ...
        public void SetData(CLDC_DataCore.Model.DnbModel.DnbInfo.MeterBasicInfo MeterInfo, bool allowedit)
        {
            ...
            for (int intCurrentNum = 0; intCurrentNum <= 12; intCurrentNum++)
            {
                ...
                if (MeterInfo.MeterFunctions[_Key].Mf_chrValue.IndexOf(',') == -1)
                    continue;
                arrValue = MeterInfo.MeterFunctions[_Key].Mf_chrValue.Trim().Split(',');
