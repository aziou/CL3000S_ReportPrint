	...
	public class Cell : Virtual.CellVirtual, ICell
	{
		...
		public int ColumnSpan
		{
			...
			set
			{
                ...
                if (value > Grid.MaxSpan)
                    throw new SourceGridException("ColumnSpan must be smaller than Grid.MaxSpan property. Increase the property or use a smaller column span.");
		...
		public int RowSpan
		{
			...
			set
			{
                ...
                if (value > Grid.MaxSpan)
                    throw new SourceGridException("RowSpan must be smaller than Grid.MaxSpan property. Increase the property or use a smaller row span.");
