...
namespace SourceGrid.Cells.Editors
{
    ...
    /// <returns></returns>
    public delegate bool EventOnEditerValueChanged(EditorBase editor, object newValue);

    /// <summary>
    /// 单元格子点击事件
    /// </summary>
    /// <param name="cell"></param>
    public delegate void EventOnEditerClick(EditorBase editor);
    ...
    public class EditorBase : DevAge.ComponentModel.Validator.ValidatorTypeConverter
	{
        ...
        private   Cells.Cell PrvCell = null ;

        public Cells.Cell Cell
        {
            get { return PrvCell; }
            set { if (PrvCell == null) PrvCell = value; }
        }
        ...
        /// 值被改变事件
        /// </summary>
        public EventOnEditerValueChanged OnEditerValueChanged;

        /// <summary>
        /// 单元格点击事件
        /// </summary>
        public EventOnEditerClick OnEditerClick;
